...
function(a, b) {
    ...
    d = {
        ...
        _createButtons: function() {
			...
			b('<div class="sp_index"><font class="banner_button_num_l">'+(this.getSelectedSlide() + 1)+'</font><font class="banner_button_num_r">/'+this.getTotalSlides()+'</font></div>').appendTo(this.$buttons);
