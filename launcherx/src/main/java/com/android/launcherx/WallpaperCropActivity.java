...
import com.android.launcherx.wallpaper.R;
...
public class WallpaperCropActivity extends Activity {
    ...
    static protected Point getDefaultWallpaperSize(Resources res, WindowManager windowManager) {
        if (true) {//sDefaultWallpaperSize == null
            Point minDims = new Point();
            Point maxDims = new Point();
            windowManager.getDefaultDisplay().getCurrentSizeRange(minDims, maxDims);

            Log.d(LOGTAG, "getDefaultWallpaperSize: maxDims.x="+maxDims.x);
            Log.d(LOGTAG, "getDefaultWallpaperSize: maxDims.y="+maxDims.y);
            Log.d(LOGTAG, "getDefaultWallpaperSize: minDims.x="+minDims.x);
            Log.d(LOGTAG, "getDefaultWallpaperSize: minDims.y="+minDims.y);
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.JELLY_BEAN_MR1) {
                ...
                Log.d(LOGTAG, "getDefaultWallpaperSize: realSize.x="+realSize.x);
                Log.d(LOGTAG, "getDefaultWallpaperSize: realSize.y="+realSize.y);
            ...
            if (isScreenLarge(res)) {
                Log.d(LOGTAG, "getDefaultWallpaperSize: wallpaperTravelToScreenWidthRatio="+wallpaperTravelToScreenWidthRatio(maxDim, minDim));
...
//        cropTask.setNoCrop(true);
    ...
    private static boolean isScreenLarge(Resources res) {
        ...
        Log.d(LOGTAG, "isScreenLarge: smallestScreenWidthDp="+config.smallestScreenWidthDp);
...
//        cropTask.setNoCrop(true);
    ...
    protected void updateWallpaperDimensions(int width, int height) {
        Log.d(LOGTAG, "updateWallpaperDimensions: width="+width+"\theight="+height);
    ...
    static public void suggestWallpaperDimension(Resources res,
        ...
        Log.d(LOGTAG, "suggestWallpaperDimension: savedWidth="+savedWidth);
        Log.d(LOGTAG, "suggestWallpaperDimension: savedHeight="+savedHeight);
        ...
        if (savedWidth == -1 || savedHeight == -1) {
            if (!fallBackToDefaults) {
                ...
                Log.d(LOGTAG, "suggestWallpaperDimension: defaultWallpaperSize.x="+defaultWallpaperSize.x);
                Log.d(LOGTAG, "suggestWallpaperDimension: defaultWallpaperSize.y="+defaultWallpaperSize.y);
            }
        }

        Log.d(LOGTAG, "suggestWallpaperDimension: wallpaperManager.getDesiredMinimumWidth()="+wallpaperManager.getDesiredMinimumWidth());
        Log.d(LOGTAG, "suggestWallpaperDimension: wallpaperManager.getDesiredMinimumHeight()="+wallpaperManager.getDesiredMinimumHeight());
