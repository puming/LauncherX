...
import com.android.launcherx.FolderIcon.FolderRingAnimator;
import com.android.launcherx.Launcher.CustomContentCallbacks;
import com.android.launcherx.Launcher.LauncherOverlay;
import com.android.launcherx.LauncherSettings.Favorites;
...
//        moveToScreen(mDefaultPage, animate);
        if (hasCustomContent() && getCurrentPage() == mDefaultPage) {//mCurrentPage
            moveToCustomContentScreen(animate);
        } else {
            moveToScreen(mDefaultPage, animate);
        }
    }
